...
import static com.example.aircraftwar2024.activity.MainActivity.isMusicOn;
...
public abstract class BaseGame extends SurfaceView implements SurfaceHolder.Callback, Runnable{
    ...
    private void paintScoreAndLife() {
        ...
        // Drawing life
        canvas.drawText("Life: " + heroAircraft.getHp(), 50, 200, textPaint);
    }


    @Override
    public void surfaceCreated(@NonNull SurfaceHolder surfaceHolder) {
        Log.i(TAG, "Surface created, starting game thread");
        mbLoop = true;
